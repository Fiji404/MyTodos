declare module 'js-datepicker' {
    export type DatepickerOptions = {
         ...
         */
        formatter?(input: HTMLInputElement, date: Date, instance: DatepickerInstance): void;
    ...
    function datepicker(selector: Selector, options?: DatepickerOptions): DatepickerInstance;
    function datepicker(selector: Selector, options: DaterangePickerOptions): DaterangePickerInstance;
